...
public class MostraParametri extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/* Sto dicendo che il contenuto della mia risposta è 
		un documento Html*/
		response.setContentType("text/html");
		
		//preparo un oggetto su cui scrivere la risposta
		/*L'oggetto è un'istanza della classe PrintWriter che viene
		...
		out.println("<ul>");
		out.println("<li>Nome: <b>"+nome.toUpperCase()+"</b></li>");
		out.println("<li>Cognome: <b>"+cognome.toUpperCase()+"</b></li>");
		out.println("</ul>");
